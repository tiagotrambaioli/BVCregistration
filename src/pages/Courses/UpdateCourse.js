...
import { useParams, Link as RouterDom, useNavigate } from 'react-router-dom';
...
export default function UpdateCourse() {
  ...
  useEffect(() => {
    ...
    setCourseCredits(course?.courseCredits);
    setTuitionPeriod(course?.tuition?.period.toString());
    setTuitionDomestic(course?.tuition?.domestic);
    setTuitionInternational(course?.tuition?.international);
    setOutlines(course?.outlines);
  }, [course]);
  useEffect(() => {}, [outlines]);
  return (
    <Card
